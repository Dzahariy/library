...
(function( $ ) {
	wp.customize.bind( 'ready', function() {
		...
		function digital_books_customizer_label( id, title ) {
			...
			if ( id === 'book_publisher_topbar_text' || id === 'digital_books_facebook_icon' || id === 'digital_books_twitter_icon' || id === 'digital_books_intagram_icon'|| id === 'digital_books_linkedin_icon'|| id === 'digital_books_pintrest_icon' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-digital_books_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'book_publisher_latest_product_section_setting' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-digital_books_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'digital_books_footer_text_setting' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-digital_books_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
		...
		// Social Icon
		digital_books_customizer_label( 'book_publisher_topbar_text', 'Text' );
		...
		//Latest Product
		digital_books_customizer_label( 'book_publisher_latest_product_section_setting', 'Latest Product' );

		//Featured Product
		digital_books_customizer_label( 'digital_books_product_section_setting', 'Featured Product' );

		//Footer
		digital_books_customizer_label( 'digital_books_footer_text_setting', 'Footer' );
